...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/simple-sidebar.css" type="text/css"/>
    ...
    <body>
        ...
        <script type="text/javascript" rel= href="${pageContext.request.contextPath}/js/bootstrap.bundle.min.js"/>
